...
def make_trade(**kwargs):
    u = str(uuid.uuid4())
    base = dict(
        tradeId=u, userId=str(uuid.uuid4()), sessionId=str(uuid.uuid4()), asset="NVDA",
